    ...
    style={{
        ...
        <div className="flex flex-col items-center justify-center gap-2">
            ...
            <div className="flex flex-col text-center items-center justify-center">
                <h1 className="font-bold text-lg text-center">{modpack.name}</h1>
                <p className="text-center text-md w-full">By {modpack.user!.name}</p>
            </div>
        </div>
    </BreadCrumbLink>
}
